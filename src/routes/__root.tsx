...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ZUNO — Secure Escrow Payments" },
      { name: "description", content: "ZUNO is a secure payment and marketplace platform. Pay verified sellers safely with escrow protection." },
...
const themeInitScript = `(function(){try{var s=localStorage.getItem('zuno-theme');var d=s?s==='dark':window.matchMedia('(prefers-color-scheme: dark)').matches;if(d)document.documentElement.classList.add('dark');}catch(e){document.documentElement.classList.add('dark');}})();`;
